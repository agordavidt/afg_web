            ...
            <div class="card-header">
                <div class="card-head-row">
                    <div class="card-title">
                        <i class="fas fa-money-check-alt me-2"></i>Paid Students
                    </div>
...
<div class="card">
    <div class="card-header">
        <div class="d-flex align-items-center">
            <h4 class="card-title">Students Who Have Paid ({{ $users->total() }})</h4>
            <div class="ml-auto">
                <form method="GET" class="d-flex flex-wrap gap-2 align-items-center">
                    ...
                    @if(request()->hasAny(['search', 'school']))
                        <a href="{{ route('admin.users.paid') }}" class="btn btn-secondary btn-sm">
                ...
                <tbody>
                    @forelse($users as $user)
                        <tr>
                            ...
                            <td>
                                <span class="badge badge-{{ $user->registration_stage == 'completed' ? 'success' : 'warning' }}">
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="text-center py-4">
                                ...
                                <p class="text-muted">No paid students found</p>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
...
@include('admin.users.partials.sms-modals', ['schools' => $schools, 'bulkRecipient' => 'paid'])
@endsection